...
namespace SharpBCI.Extensions.Paradigms.Countdown
{
    ...
    public class CountdownParadigm : StagedParadigm.Basic
    {
        ...
        public const string ParadigmName = "Countdown";
        ...
        public class Factory : ParadigmFactory<CountdownParadigm>
        {
            ...
            public override CountdownParadigm Create(IReadonlyContext context) => new CountdownParadigm(new Configuration
            {
        ...
        public CountdownParadigm(Configuration configuration) : base(ParadigmName) => Config = configuration;

        public override void Run(Session session) => new CountdownExperimentWindow(session).ShowDialog();
