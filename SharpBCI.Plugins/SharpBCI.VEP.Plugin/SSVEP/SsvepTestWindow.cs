...
namespace SharpBCI.Experiments.VEP.SSVEP
{
    ...
    internal class SsvepTestWindow : RenderForm, IDisposable
    {
        ...
        private readonly SsvepExperiment _experiment;

        private readonly IMarkable _markable;

        private readonly StageProgram _stageProgram;

        private readonly SsvepExperiment.Configuration.TestConfig.StimulationParadigm _paradigm;
        ...
        private void UpdateBlocks()
        {
            ...
            var layout = _experiment.Config.Gui.BlockLayout;
            var position = _experiment.Config.Gui.BlockPosition;
            float winW = Width, winH = Height;
            float blockFrameW, blockFrameH;
            float offsetX = 0, offsetY = 0;

            var blockWidth = (int)(_experiment.Config.Gui.BlockSize.Width * scaleFactor);
            var blockMarginH = (int)(_experiment.Config.Gui.BlockSize.HMargin * scaleFactor);
            ...
            var blockHeight = (int)(_experiment.Config.Gui.BlockSize.Height * scaleFactor);
            var blockMarginV = (int)(_experiment.Config.Gui.BlockSize.VMargin * scaleFactor);
