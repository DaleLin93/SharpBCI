...
namespace SharpBCI.BiosignalSources
{
    ...
    public class NeuroElectricsSampler : BiosignalSource
    {

        public const string DeviceName = "NeuroElectrics";

        public class Factory : DeviceFactory<NeuroElectricsSampler, IBiosignalSource>
        {
        ...
        public override ISample Read() => new Sample(ReadValues(_stream, _localBuf.Value, 2000));
