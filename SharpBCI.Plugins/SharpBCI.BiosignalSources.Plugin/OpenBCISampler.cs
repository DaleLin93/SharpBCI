...
namespace SharpBCI.BiosignalSources
{
    ...
    public class OpenBCISampler : BiosignalSource
    {

        public const string DeviceName = "OpenBCI";

        public class Factory : DeviceFactory<OpenBCISampler, IBiosignalSource>
        {
        ...
        public override ISample Read() => new Sample(ReadValues(_serialPort, _localBuf.Value, ChannelNum, 2000));
