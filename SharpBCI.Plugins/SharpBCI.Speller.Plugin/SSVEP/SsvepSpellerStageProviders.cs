...
namespace SharpBCI.Experiments.Speller.SSVEP
{
    ...
    internal class SsvepStaticSpellerStageProvider : SpellerStageProvider<RepeatingStageProvider>
    {
        ...
        public SsvepStaticSpellerStageProvider(SpellerController spellerController, SpellerExperiment.Configuration.TestConfig testConfig)
    ...
    internal class SsvepDynamicSpellerStageProvider : SpellerStageProvider<PipelinedStageProvider>
    {
        ...
        public SsvepDynamicSpellerStageProvider(SpellerController spellerController, SpellerExperiment.Configuration.TestConfig testConfig)
    ...
    internal static class SsvepSpellerStageProviderUtils
    {
        ...
        public static IStageProvider GetExperimentProvider(SpellerController spellerController,
            SpellerExperiment.Configuration.TestConfig testConfig)
        {
