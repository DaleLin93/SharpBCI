...
namespace SharpBCI.Experiments.Speller
{
    ...
    internal class ButtonInsideTrialTrigger : ITrialTrigger
    {
        ...
        private readonly Func<Point, SpellerBaseWindow.UIButton> _findButtonFunc;
        ...
        private SpellerBaseWindow.UIButton _previousHover;
    ...
    internal abstract class SpellerBaseWindow : RenderForm, IDisposable
    {
        ...
        protected readonly SpellerExperiment Experiment;

        protected readonly SpellerExperiment.Result Result;
        ...
        protected bool ExperimentStarted = false;
        ...
        protected virtual SpellerExperiment.Result CreateResult(Session session) => new SpellerExperiment.Result();
        ...
        {
            switch (Experiment.Config.Test.ActivationMode)
            {
        ...
        {
            if (!Experiment.Config.Gui.InputBarVisibility) return;
        ...
        {
            InputBoxHeight = Experiment.Config.Gui.InputBarVisibility 
                ? Experiment.Config.Gui.InputTextFontSize * ScaleFactor * 2 : 0;
            var rows = LayoutSize[0];
            var cols = LayoutSize[1];
            var buttonSize = Experiment.Config.Gui.ButtonSize * ScaleFactor;
            var buttonMargin = Experiment.Config.Gui.ButtonMargin * ScaleFactor;
