...
namespace SharpBCI.Paradigms.MRCP
{
    ...
    /// <summary>
    /// Interaction logic for MrcpExperimentWindow.xaml
    /// </summary>
    internal partial class MrcpExperimentWindow
    {
        ...
        public MrcpExperimentWindow(Session session)
        {
            InitializeComponent();
            _session = session;
            var paradigm = (MrcpParadigm) session.Paradigm;
        ...
        private void StageProgram_StageChanged(object sender, StageChangedEventArgs e)
        {
            ...
            this.DispatcherInvoke(() =>
            {
                ...
                /* Paradigm start */
                if (stage.Marker == MarkerDefinitions.ParadigmStartMarker)
