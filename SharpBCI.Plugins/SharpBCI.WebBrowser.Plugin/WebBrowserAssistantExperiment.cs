...
namespace SharpBCI.Experiments.WebBrowser
{
    ...
    public class WebBrowserAssistantExperiment : Experiment
    {
        ...
        public const string ExperimentName = "Web Browser Assistant [Server]";
        ...
        public class Factory : ExperimentFactory<WebBrowserAssistantExperiment>
        {
        ...
        static WebBrowserAssistantExperiment()
        {
            var type = typeof(WebBrowserAssistantExperiment);
        ...
        public WebBrowserAssistantExperiment(Configuration configuration) : base(ExperimentName) => Config = configuration;
